...
To get an idea of how grain yields and fertilizer use separately vary across the globe, we created world maps of the two variables:


Above is the scatterplot of grain yield in metric tons produced per hectare against fertilizer in kilograms applied per hectare. 
